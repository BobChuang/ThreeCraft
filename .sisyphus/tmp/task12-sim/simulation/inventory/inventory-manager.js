...
class SimulationInventoryManager {
	...
	getInventory(entityId) {
		var _a;
		const inventory = (_a = this.inventories.get(entityId)) !== null && _a !== void 0 ? _a : this.registerEntity(entityId);
	...
	addItem(entityId, itemType, quantity, maxStack) {
		...
		return (0, add_item_1.addItemToInventory)(inventory, item.type, quantity, maxStack !== null && maxStack !== void 0 ? maxStack : item.maxStack);
	}
