...
class SimulationSurvivalManager {
	...
	tickEntity(entityId, elapsedMs) {
		var _a, _b, _c;
		const state = (_a = this.states.get(entityId)) !== null && _a !== void 0 ? _a : this.registerEntity(entityId);
		const previous = cloneState(state);
		const hungerTime = ((_b = this.hungerElapsed.get(entityId)) !== null && _b !== void 0 ? _b : 0) + Math.max(0, elapsedMs);
		...
		const hpTime = ((_c = this.hpElapsed.get(entityId)) !== null && _c !== void 0 ? _c : 0) + Math.max(0, elapsedMs);
