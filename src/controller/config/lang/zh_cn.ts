...
const language = {
	...
	norm: '一般&nbsp;&nbsp',
	threadNumber: '线程数',
	weatherName: ['经典', '冰雪', '月下沙滩瓜田', '南瓜田🎃', '奇异', 'Cyberpunk'],
	weather: '场景',
	...
	possessionStart: '正在附身',
	possessionRelease: '已解除附身',
	possessionNoTarget: '附近没有可附身的 NPC',
	possessionConflict: '已处于附身状态, 请先按 Tab 解除',
	linkServer: '连接到服务器',
