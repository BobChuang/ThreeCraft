...
export default {
	...
	possessionStart: 'Possessing',
	possessionRelease: 'Possession released',
	possessionNoTarget: 'No nearby NPC to possess',
	possessionConflict: 'Already possessing an NPC. Press Tab to release first',
